...
module.exports = function (app) {
  ...
  function setPalette (palette) {
    ...
    lines.forEach((mesh, i) => {
      ...
      tweenr.to(uniforms.animateRadius, { value: 1, duration: 10, delay, ease: 'linear' });
      tweenr.to(uniforms.animateStrength, { value: 0, duration: 20, delay, ease: 'expoInOut' });
    });
  }
